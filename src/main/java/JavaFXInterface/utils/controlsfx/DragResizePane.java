...
/**
 * {@link DragResizePane} can be used to add mouse listeners to a {@link Region}
...
public class DragResizePane {
	...
	private DragResizePane(Region aRegion) {
		region = aRegion;
	}

	public static void makeResizable(Region region) {
		final DragResizePane resizer = new DragResizePane(region);
